    ...
    <div class="flex items-center justify-center ">
        <div class="shadow-lg rounded-lg w-5/6 overflow-hidden flex flex-col items-center justify-center">
            ...
            <div class="flex flex-wrap items-center justify-center pb-6">
                <div v-for="(item, index) in data" :key="item.id" class="w-1/4 p-8 mx-2 mb-3 bg-white1">
                    <div class="w-[240px] h-[400px] overflow-hidden flex justify-center items-center">
                        <img :src="item.gambar_url" alt="style_image" class="object-cover w-full h-full">
                    </div>
