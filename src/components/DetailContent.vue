...
<template>
  ...
  <div class="container w-[86rem] h-[727px] mt-[74px] bg-white">
    <p class="relative leading-6 font-display ms-40 top-3 text-6">Formal Style</p>
    <div class="container w-[720px] relative right-[10.5rem] drop-shadow-2xl h-[613px] mt-[44px] bg-white">
      <div v-if="style">
        <div v-for="style in style" >
          <img
  ...
  <div class="container w-[86rem] h-[727px] mt-[74px] bg-white">
    <p class="relative leading-6 font-display ms-40 top-3 text-6">Street Style</p>
    <div class="container w-[720px] relative right-[10.5rem] drop-shadow-2xl h-[613px] mt-[44px] bg-white">
      <div v-if="style">
        <div v-for="style in style" >
          <img
  ...
  <div class="container w-[86rem] h-[727px] mt-[74px] bg-white">
    <p class="relative leading-6 font-display ms-40 top-3 text-6">Islami Style</p>
    <div class="container w-[720px] relative right-[10.5rem] drop-shadow-2xl h-[613px] mt-[44px] bg-white">
      <div v-if="style">
        <div v-for="style in style" >
          <img
  ...
  <div class="container w-[86rem] h-[727px] mt-[74px] bg-white">
    <p class="relative leading-6 font-display ms-40 top-3 text-6">Vintage Style</p>
    <div class="container w-[720px] relative right-[10.5rem] drop-shadow-2xl h-[613px] mt-[44px] bg-white">
      <div v-if="style">
        <div v-for="style in style" >
          <img
