  ...
  <div class="flex flex-wrap">
    ...
    <div class="flex" style="width: 100vw; height: 100%">
            ...
            <form class="mt-4" @submit.prevent="submitForm">
              ...
              <div class="mb-3 ">
                <button
                  ...
                  <google-signin-button :client-config="googleConfig" @success="handleGoogleSignInSuccess"
      ...
      <div class="flex flex-wrap rounded-r-md" style="width: 100%; height: 100vh">
        <img class="w-full h-full mr-0 bg-no-repeat bg-cover" style="width: 100vw; height: 100vh"
