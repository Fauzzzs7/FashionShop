...
export default {
  ...
  methods: {
    handleSubmit() {
      ...
      axios.post('http://127.0.0.1:5173/signup', data)
        .then((Response) => {
        ...
        <div class="flex flex-wrap content-center justify-center mt-56 bg-gray-200 rounded-lg font-desc bg-secondGrey"
          ...
          <div class="w-72">
            ...
            <form @submit.prevent="handleSubmit" class="mt-4">
              <div class="mb-3">
                <label class="block mb-2 text-xs font-semibold">Name</label>
                <input v-model="name" type="name" placeholder="Enter your name" class="block w-full rounded-md border border-gray-300 focus:border-purple-700 
