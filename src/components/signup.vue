...
<template>
  <div class="flex flex-wrap">
    <div class="flex" style="width: 100vw; height: 100%">
      ...
      <div class="flex content-center justify-center bg-white" style="width: 100vw; height: 100vh"><router-link to="/">
          <button>
            <img src="../assets/logo_web.svg" style="width: 40px; height: 40px; margin-top: 20px;" />
          </button>

        </router-link>
        <div class="flex flex-wrap content-center justify-center mt-56 rounded-lg font-desc bg-secondGrey"
          ...
          <div class="w-72">
            ...
            <form class="mt-4" @submit.prevent="submitForm">
              ...
              <div class="mb-3">
                ...
                <input type="text" placeholder="Enter your username" v-model="name" required
            ...
            <div class="text-center">
              <span class="text-xs font-semibold text-gray-400">Already have account? </span>
      ...
      <div class="flex flex-wrap rounded-r-md" style="width: 100%; height: 100vh">
        <img class="w-full h-full bg-no-repeat bg-cover" style="width: 100vw; height: 100vh"
